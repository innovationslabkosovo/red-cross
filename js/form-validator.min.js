...
(function($) {
    ...
    var _applyErrorStyle = function($elem, conf) {
            ...
            if(conf.borderColorOnError !== '') {
                ...
                $('select.error').parent().css("border-bottom-color", "red");
            }
        },
        ...
        _setInlineErrorMessage = function($input, mess, conf) {
            ...
            if( custom ) {
                ...
                if ($('.error').length > 0) {
                	...
                	// $(".form-error-message").html('Keni probleme me fushat, ju lutemi ti rishikoni perseri');
                	$(".form-error-message").html(mess);
                } else {
