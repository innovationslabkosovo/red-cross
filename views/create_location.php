...
<td>
    <a id="results_<?php echo $id; ?>" class="text" href="https://www.google.com/maps?q=<?php echo $latitude.','.$longitude; ?>" target="_blank"><?php echo $location_name; ?></a>
...
<td>
    <a href="https://www.google.com/maps?q=<?php echo $coords[1].','.$coords[0];?>" target="_blank"><?php echo $municipality_name; ?></a>
</td>
<td>
